...
function MediaForm({
  ...
  return (
    ...
    >
      {/* ── DROP ZONE ── */}
      <SectionCard title="File Upload" icon={<CloudUploadOutlined />}>
        {!previewUrl ? (
          <Dragger
      ...
      <SectionCard title="Media Details" icon={<FileTextOutlined />}>
        ...
        <Form.Item name="banner" label="Banner" style={{ marginBottom: 16 }}>
          <Input
            prefix={<TagOutlined style={{ color: "rgba(133,74,154,0.4)" }} />}
            size="large"
            placeholder="Custom banner tag. E.g. Kajiado Visit"
            style={{
              borderRadius: 8,
